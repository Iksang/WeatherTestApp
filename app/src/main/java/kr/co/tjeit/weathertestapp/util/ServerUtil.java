...
//    2. 해당 기능을 사용하기 위해 우리가 제공해야하는 데이터도 알아내자.
//    3. 해당 주소/데이터를 기반으로 메쏘드 생성

    public static void getCurrentWeatherFromServer(final Context context,final String lat,final String lon, final JsonResponseHandler handler) {
...
//        기능능을 사용하기 해 필요한 데이터를 담는 부분.

        Map<String, String> data = new HashMap<String, String>();
//        data.put("version","1");
//        data.put("lat","37.572960");
//        data.put("lon"," 126.971844");
