		...
		if (isNetworkAvailable(context)) {
			AsyncTaskHandler async = new AsyncTaskHandler() {
				...
				public String doInBackground() {
					...
					if (params == null)
						return HttpRequest.get(url).header("appKey","9c2af7be-c55c-3b1d-9658-b2c0065f5f04").body();
					else
						return HttpRequest.get(url).header("appKey","9c2af7be-c55c-3b1d-9658-b2c0065f5f04").form(params).body();
				}
			};
